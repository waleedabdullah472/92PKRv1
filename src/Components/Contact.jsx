  ...
  return (
    <div className={`contact-container ${isVisible ? 'fade-in' : ''}`}>
      <div className="contain-card">
        <h2>Contact Us</h2>
        <h4>Get in Touch with <a href="https://www.92pkru.com/#/register?invitationCode=67373190526" target="_blank" rel="noopener noreferrer">92 PKR Game</a></h4> {/* Added target and rel */}
